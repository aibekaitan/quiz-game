...
import { GameViewModel, PlayerProgressViewModel, AnswerViewModel } from '../api/dto/quiz-game.dto';
...
export class QuizGameQueryRepository {
  mapGameToView(game: QuizGame): GameViewModel {
    return {
      id: game.id,
      firstPlayerProgress: this.mapPlayerProgressToView(game.firstPlayerProgress),
  ...
  private mapPlayerProgressToView(progress: QuizPlayerProgress): PlayerProgressViewModel {
    return {
